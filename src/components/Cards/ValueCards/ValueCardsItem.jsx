    ...
    < >
        <div className="values"> 
            <div className="value">
                ...
                <p className="value__text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos, reiciendis fugiat nihil cumque atque aspernatur explicabo </p>
            </div>
            <div className="value">
                <img className='value__image' src={Value_1} alt="first icon" />
                <p className="value__text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos, reiciendis fugiat nihil cumque atque aspernatur explicabo </p>
